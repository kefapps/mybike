...
- Grill-with-docs decisions:
  ...
  - Visual treatment: emissive materials with bounded pulse animation.
  - Placement: entry marker plus secondary beacons inside each segment.
  - Covered segments: `Climb`, `Sprint`, `Recovery`; no dedicated `Warmup` cue.
  - First implementation: Unity primitives generated by code.
...
- Linear implementation comment:
  `cacf9759-df33-493d-9209-0b1a81f429bb`.
