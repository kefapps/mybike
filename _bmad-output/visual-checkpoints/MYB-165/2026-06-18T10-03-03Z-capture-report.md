...
Generated at:
- 2026-06-18T10:03:03.8059880Z

Output directory:
- `_bmad-output/visual-checkpoints/MYB-165/`

Metadata:
- `_bmad-output/visual-checkpoints/MYB-165/2026-06-18T10-03-03Z-capture-metadata.json`
...
|---|---|---|---|---|---|
| after | route | `_bmad-output/visual-checkpoints/MYB-165/2026-06-18T10-03-03Z-after-route.png` | `Assets/Scenes/MYB89UnityMcpProbe.unity` | RouteCamera | 1600x900 |
| after | overview | `_bmad-output/visual-checkpoints/MYB-165/2026-06-18T10-03-03Z-after-overview.png` | `Assets/Scenes/MYB89UnityMcpProbe.unity` | OverviewCamera | 1600x900 |
...
| Code | Message |
|---|---|
| CAPTURE_WRITTEN | route after capture written to `_bmad-output/visual-checkpoints/MYB-165/2026-06-18T10-03-03Z-after-route.png`. |
| CAPTURE_WRITTEN | overview after capture written to `_bmad-output/visual-checkpoints/MYB-165/2026-06-18T10-03-03Z-after-overview.png`. |
