...
version: 0.5.0
description: |
  Game development workflow skills for game design, planning, implementation review, QA,
  and production readiness across GDD, mechanics, balance, and visual polish.
allowed-tools:
  - Bash
  - Read
  - AskUserQuestion
